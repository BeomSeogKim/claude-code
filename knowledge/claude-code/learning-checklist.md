...
### CLAUDE.md 마스터하기
- [ ] `/init`으로 자동 생성하고 커스터마이징하기
- [ ] 간결함 유지 원칙 이해 (1페이지 이내)
- [ ] `@` 문법으로 다른 파일 import 활용
- [ ] 위치별 우선순위 이해 (home → project → child)
...
(학습 완료 시 여기에 날짜와 핵심 인사이트 기록)

**예시**:
```
[2026-02-16] ✓ /init으로 CLAUDE.md 생성
- 인사이트: 자동 생성된 것도 좋지만, 프로젝트 특성에 맞게 커스터마이징 필수
- 다음: Bash 명령어 섹션 추가 필요
```
